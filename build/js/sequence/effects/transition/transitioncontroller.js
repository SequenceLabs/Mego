(function() {
  ...
  effects.TransitionController = (function() {
    ...
    function TransitionController(options) {
      var element, elements, i, _i, _len, _ref;
      ...
      for (_i = 0, _len = elements.length; _i < _len; _i++) {
        ...
        _results.push((function() {
          ...
          for (prop in _ref) {
            ...
            _results1.push(new effects.TransitionDelegate(element, prop, value, this.options.duration));
          }
          return _results1;
        }).call(this));
      }
    ...
    TransitionController.prototype.onTransitionEnd = function(e) {
      ...
      if (this.numTransitionsComplete === this.numTransitions) {
        if (this.options.complete != null) {
          return this.options.complete.call(this);
        }
      }
    };
